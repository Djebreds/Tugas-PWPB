...
// melakukan redirect ke halam simpan.php
if (isset($_POST['show'])) {
    header('Location: simpan.php');
    exit();
}

// melakukan pencarian data menggunakan berdasarkan NIS
...
<body>
    ...
    <form action="" method="POST" align="center">
        ...
        <input type="text" name="cari" id="cari" maxlength="9" placeholder="Nis Siswa...">
